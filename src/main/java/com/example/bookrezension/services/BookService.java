package com.example.bookrezension.services;

import com.example.bookrezension.models.Book;
import com.example.bookrezension.models.Image;
import com.example.bookrezension.models.User;
import com.example.bookrezension.repositories.BookRepository;
import com.example.bookrezension.repositories.UserRepository;
...
public class BookService{
    ...
    public void saveBook(Principal principal,Book book, MultipartFile file1, MultipartFile file2, MultipartFile file3) throws IOException{
        ...
        log.info("Saving new Book. Title: {}; Author: {}; AuthorPost: {}", book.getTitle(), book.getAuthor(),
                book.getUser().getName());

        Book bookFormDb = bookRepository.save(book);
        bookFormDb.setPreviewImageId(bookFormDb.getImages().get(0).getId());
